...
{
    [AddInExtension("DataTypes Background Worker", "Loads data type statistics using a background worker", "Samples")]
    public class BackgroundWorkerWizardExtension : IEditorWizardExtension
    {
        ...
        public void Run(IEditorApplication context, IBehavior behavior)
        {
            ...
            try
            {
                ...
                {
                    DataContext = new BackgroundWorkerMainViewModel(context.Workspace.ActiveProject)
                };
